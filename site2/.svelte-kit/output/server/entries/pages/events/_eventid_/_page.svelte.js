...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function loadEventText() {
    try {
      ...
      const jsonModule = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../lib/texts/test.json": () => import("../../../../chunks/test.js") }), `../../../lib/texts/${data.eventid}.json`, 6);
      return jsonModule.default?.text || "";
    } catch (error) {
      console.error("Error loading event text:", error);
      return "";
